...
#Three inputs
#1.  Input Twitter user handle without the @ symbol
twitterUserHandle = ""
...
#Download tweets
for status in tweepy.Cursor(api.user_timeline, user_id=twitterUserHandle, tweet_mode="extended").items(numberTweetsDownload):
    ...
    if status._json["is_quote_status"] == True:
        ...
        try:
            ...
            originTweetID = "Suspended account"
            originTweetLocalDateTime = "Suspended account"
            originTweetDate, originTweetTime = "Suspended account", "Suspended account"
            originTweetHandle = "Suspended account"
            originTweetText = "Suspended account"
        try:
